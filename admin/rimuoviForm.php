...
<html>
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <form action="rimuoviForm.php" method="get">
                ...
                if(isset($_GET["nomeAula"])){
                        ...
                        $stm = $conn->prepare("select nome, info from aule where nome like (?)");
                        $param = '%' . $_GET["nomeAula"] . '%';
                        ...
                        if ($stm->execute()) {
                            ...
                            while($row = $result->fetch_assoc()){
                                echo    '<a href="https://localhost/SitoAule/admin/rimuovi.php?aula=' . $row["nome"] . '" class="list-group-item">
